...
export class Region {
    ...
    getProvince() {
        ...
        for (const k in region) {
            if (k.substr(2, 4) === '0000') {
                // console.log(k.substr(2,4));
                province.push({ value: k, label: region[k] });
            }
        }
    ...
    getCity(value: string) {
        const cities: any[] = [];
        for (const k in region) {
            if (k.substr(0, 2) === value.substr(0, 2) && k !== value) {
                // console.log(k.substr(2,4));
                cities.push({ value: k, label: region[k] });
            }
        }
        // console.log(cities);
        return cities;
